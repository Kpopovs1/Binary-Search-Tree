...
/*For Lab 6, implement a templated Binary Search Tree and to measure the runtime of your 
implementation. Your BST class should support the following public member functions, with 
the usual definitions:
•	bool insert(const T &);
•	bool remove(const T &);
•	bool find(const T &) const;
•	void display() const; // inorder display
Your code should reject duplicate insertions. Design a set of tests to see whether your 
...
Turn in your code and a 1 page “report”, including a graph, to report your findings. 
Your report should concisely (a) state the problem you set out to solve, (b) describe the 
tests you ran, and (c) draw conclusions.*/
